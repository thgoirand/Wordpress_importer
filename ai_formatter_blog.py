...
AI_PROMPT_CLASSIFICATION = (
    "Tu es un expert en analyse de contenu et en marketing B2B pour l'achat de logiciels en ligne. "
    "Analyse ce contenu markdown d'un article de blog et reponds aux 3 questions suivantes.\n\n"
    "1. **has_regulatory_content** (true/false) : Le contenu contient-il des references "
    "a une reglementation, un texte de loi, une directive, une norme, un decret ou tout cadre juridique/legal ? "
    "Exemples positifs : RGPD, DORA, loi de finances, code du travail, directive europeenne, norme ISO.\n\n"
    "2. **has_country_specific_context** (true/false) : Le contenu presente-t-il un contexte "
    "specifique a un pays ou un marche particulier (fiscalite francaise, marche espagnol, "
    ...
    "3. **funnel_stage** (TOFU/MOFU/BOFU) : A quel stade du funnel marketing s'adresse ce contenu "
    "pour un prospect dans un parcours d'achat de logiciel ?\n"
    "- TOFU (Top of Funnel) : sensibilisation et decouverte. Articles educatifs, guides generaux, "
    "definitions de concepts, tendances du marche, bonnes pratiques generales.\n"
    "- MOFU (Middle of Funnel) : evaluation et consideration. Comparatifs de solutions, guides de choix, "
    "criteres de selection, cas d'usage detailles, webinars thematiques, livres blancs approfondis.\n"
    "- BOFU (Bottom of Funnel) : decision et conversion. Demos produit, etudes de cas clients avec "
    "resultats chiffres, temoignages clients, fiches produit detaillees, offres d'essai, ROI concrets.\n\n"
    "Reponds UNIQUEMENT avec un objet JSON valide (sans markdown, sans explication), au format :\n"
